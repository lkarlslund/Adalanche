...
- Prerequisites: Go 1.21, PowerShell 7, git
...
The collector does not require elevated privileges, and runs fine with either the local system account with privileges stripped or as a random user.
