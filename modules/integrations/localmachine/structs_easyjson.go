		...
		case "AssignedSIDs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AssignedSIDs = append(out.AssignedSIDs, v22)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6a975c40EncodeGithubComLkarlslundAdalancheModulesIntegrationsLocalmachine8(out *jwriter.Writer, in Privilege) {
	...
	if len(in.AssignedSIDs) != 0 {
		...
		{
			out.RawByte('[')
			for v23, v24 := range in.AssignedSIDs {
				if v23 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "NetworkInterfaces":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v28 NetworkInterfaceInfo
					(v28).UnmarshalEasyJSON(in)
					out.NetworkInterfaces = append(out.NetworkInterfaces, v28)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6a975c40EncodeGithubComLkarlslundAdalancheModulesIntegrationsLocalmachine11(out *jwriter.Writer, in NetworkInformation) {
	...
	if len(in.NetworkInterfaces) != 0 {
		...
		{
			out.RawByte('[')
			for v29, v30 := range in.NetworkInterfaces {
				if v29 > 0 {
					out.RawByte(',')
				}
		...
		case "AppCache":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AppCache = append(out.AppCache, v31)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "Month":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Month = append(out.Month, v39)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "Users":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Users = append(out.Users, v46)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Groups":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Groups = append(out.Groups, v47)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Shares":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Shares = append(out.Shares, v48)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Services":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Services = append(out.Services, v49)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Software":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v50 shared.Software
					easyjson6a975c40DecodeGithubComLkarlslundGoWin64apiShared3(in, &v50)
					out.Software = append(out.Software, v50)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Tasks":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v51 RegisteredTask
					(v51).UnmarshalEasyJSON(in)
					out.Tasks = append(out.Tasks, v51)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Privileges":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Privileges = append(out.Privileges, v52)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6a975c40EncodeGithubComLkarlslundAdalancheModulesIntegrationsLocalmachine16(out *jwriter.Writer, in Info) {
	...
	if len(in.Software) != 0 {
		...
		{
			out.RawByte('[')
			for v61, v62 := range in.Software {
				if v61 > 0 {
					out.RawByte(',')
				}
				easyjson6a975c40EncodeGithubComLkarlslundGoWin64apiShared3(out, v62)
			}
			out.RawByte(']')
		}
	}
	...
	if len(in.Privileges) != 0 {
		...
		{
			out.RawByte('[')
			for v65, v66 := range in.Privileges {
				if v65 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "cpus":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v67 shared.CPU
					easyjson6a975c40DecodeGithubComLkarlslundGoWin64apiShared4(in, &v67)
					out.CPU = append(out.CPU, v67)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "memoryDIMMs":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v68 shared.MemoryDIMM
					easyjson6a975c40DecodeGithubComLkarlslundGoWin64apiShared5(in, &v68)
					out.Memory = append(out.Memory, v68)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6a975c40EncodeGithubComLkarlslundGoWin64apiShared(out *jwriter.Writer, in shared.Hardware) {
	...
	}
	{
		...
		if in.CPU == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v69, v70 := range in.CPU {
				if v69 > 0 {
					out.RawByte(',')
				}
				easyjson6a975c40EncodeGithubComLkarlslundGoWin64apiShared4(out, v70)
			}
			out.RawByte(']')
		}
	}
	{
		...
		if in.Memory == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v71, v72 := range in.Memory {
				if v71 > 0 {
					out.RawByte(',')
				}
				easyjson6a975c40EncodeGithubComLkarlslundGoWin64apiShared5(out, v72)
			}
			out.RawByte(']')
		}
	}
