...
func (z *RawObject) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = en.Append(0x82, 0xb1, 0x44, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x75, 0x69, 0x73, 0x68, 0x65, 0x64, 0x4e, 0x61, 0x6d, 0x65)
	if err != nil {
		return
	}
...
func (z *RawObject) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = append(o, 0x82, 0xb1, 0x44, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x75, 0x69, 0x73, 0x68, 0x65, 0x64, 0x4e, 0x61, 0x6d, 0x65)
...
func (z *RawObject) Msgsize() (s int) {
	s = 1 + 18 + msgp.StringPrefixSize + len(z.DistinguishedName) + 11 + msgp.MapHeaderSize
	if z.Attributes != nil {
		for za0001, za0002 := range z.Attributes {
			_ = za0002
